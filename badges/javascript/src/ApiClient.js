...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.impossiblemissionsforce.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.impossiblemissionsforce.com
         */
        ...
        this.authentications = {
            'IMF-KEY': {type: 'apiKey', 'in': 'header', name: 'IMF-KEY'}
        }
        ...
        return [
            {
              ...
              'variables': {
                domain: {
                    'description': "No description provided",
                    'default_value': "api.impossiblemissionsforce.com",
                  },
                protocol: {
                    'description': "No description provided",
                    'default_value': "https",
