...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Badges.PostBadgesRequest();
  });
  ...
  describe('PostBadgesRequest', function() {
    it('should create an instance of PostBadgesRequest', function() {
      // uncomment below and update the code to test PostBadgesRequest
      //var instance = new Badges.PostBadgesRequest();
      //expect(instance).to.be.a(Badges.PostBadgesRequest);
    });
