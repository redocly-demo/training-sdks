...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Assignments.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('getAssignets', function() {
      it('should call getAssignets successfully', function(done) {
        //uncomment below and update the code to test getAssignets
        //instance.getAssignets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
