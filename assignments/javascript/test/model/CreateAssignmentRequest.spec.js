...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Assignments.CreateAssignmentRequest();
  });
  ...
  describe('CreateAssignmentRequest', function() {
    it('should create an instance of CreateAssignmentRequest', function() {
      // uncomment below and update the code to test CreateAssignmentRequest
      //var instance = new Assignments.CreateAssignmentRequest();
      //expect(instance).to.be.a(Assignments.CreateAssignmentRequest);
    });
